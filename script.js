document.addEventListener("DOMContentLoaded", () => {
    const translations = {
        pl: {
            ...
            "proj-casino-desc": "Pełnoprawna aplikacja kasynowa z lobby gier, działającym automatem, live kasynem, bonusami i turniejami. Napisana w Angular 19 z standalone components, lazy loading i signals.",
            "feat-casino-1": "Automat",
            "feat-casino-2": "Turnieje",
        ...
        en: {
            ...
            "proj-casino-desc": "A full-featured casino app with game lobby, working slot machine, live casino, bonuses and tournaments. Built with Angular 19, standalone components, lazy loading and signals.",
            "feat-casino-1": "Slot Machine",
            "feat-casino-2": "Tournaments",
            "badge-wip": "In Development",
        ...
        ua: {
            ...
            "proj-casino-desc": "Повноцінний казино-застосунок з лобі ігор, робочим слотом, live-казино, бонусами та турнірами. Написаний на Angular 19 зі standalone components, lazy loading та signals.",
            "feat-casino-1": "Слот-машина",
            "feat-casino-2": "Турніри",
            "badge-wip": "In Development",
            "wip-label": "🚧 В розробці",
